...
function adminLogin($conn, $email, $pwd, $table)
{
    ...
    if ($checkPwd === false) {
        ...
        if ($_SESSION["role"] == "Police Officer") {
            header("location: ../../public/police-officer/po-home.php");
            exit();
        }
        if ($_SESSION["role"] == "Police Station Admin") {
            header("location: ../../public/police-station-admin/psa-home.php");
            exit();
        }
        if ($_SESSION["role"] == "RMV Admin") {
            header("location: ../../public/rmv-admin/rmv-home.php");
            exit();
        } else {
            header("location: ../../index.php?error=invalidLogin");
            exit();
