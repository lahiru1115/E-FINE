...
function lawAdd($conn, $act, $part, $chapter, $section, $title, $law, $fine, $points, $userId)
{
    ...
    $stmt = mysqli_stmt_init($conn);
    if (!mysqli_stmt_prepare($stmt, $sql)) {
        header("location: ../../public/system-admin/law-add.php?error=stmtFailed");
        exit();
    }
    ...
    mysqli_stmt_execute($stmt);
    mysqli_stmt_close($stmt);
    header("location: ../../public/system-admin/law-add.php?error=none");
    exit();
}
...
function lawView($conn)
{
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        header("location: ../../public/system-admin/law-view.php?error=noData");
        exit();
    }
}
...
function poAdd($conn, $name, $sNo, $rank, $pStation, $email, $userId)
{
    ...
    $stmt = mysqli_stmt_init($conn);
    if (!mysqli_stmt_prepare($stmt, $sql)) {
        header("location: ../../public/system-admin/po-add.php?error=stmtFailed");
        exit();
    }
...
function poView($conn)
{
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        header("location: ../../public/system-admin/po-view.php?error=noData");
        exit();
    }
}
...
function psaAdd($conn, $province, $district, $name, $email, $userId)
{
    ...
    $stmt = mysqli_stmt_init($conn);
    if (!mysqli_stmt_prepare($stmt, $sql)) {
        header("location: ../../public/system-admin/psa-add.php?error=stmtFailed");
        exit();
    }
...
function psaView($conn)
{
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        header("location: ../../public/system-admin/psa-view.php?error=noData");
        exit();
    }
}
...
function rmvAdd($conn, $name, $email, $userId)
{
    ...
    $stmt = mysqli_stmt_init($conn);
    if (!mysqli_stmt_prepare($stmt, $sql)) {
        header("location: ../../public/system-admin/rmv-add.php?error=stmtFailed");
        exit();
    }
...
function rmvView($conn)
{
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        header("location: ../../public/system-admin/rmv-view.php?error=noData");
        exit();
    }
}
